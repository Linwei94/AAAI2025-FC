...
# cifar100 fl  xuchang-lab1
CUDA_VISIBLE_DEVICES=3 python train.py --model resnet18 --loss focal_loss --dataset cifar100 --name c100_resnet18_fl  &
CUDA_VISIBLE_DEVICES=3 python train.py --model resnet34 --loss focal_loss --dataset cifar100 --name c100_resnet34_fl &
CUDA_VISIBLE_DEVICES=2 python train.py --model resnet50 --loss focal_loss --dataset cifar100 --name c100_resnet50_fl  &
CUDA_VISIBLE_DEVICES=1 python train.py --model resnet110 --loss focal_loss --dataset cifar100 --name c100_resnet110_fl &
...
# cifar100 ce  xuchang-lab1
CUDA_VISIBLE_DEVICES=3 python train.py --model resnet18 --loss cross_entropy --dataset cifar100 --name c100_resnet18_ce  &
CUDA_VISIBLE_DEVICES=3 python train.py --model resnet34 --loss cross_entropy --dataset cifar100 --name c100_resnet34_ce &
CUDA_VISIBLE_DEVICES=2 python train.py --model resnet50 --loss cross_entropy --dataset cifar100 --name c100_resnet50_ce  &
CUDA_VISIBLE_DEVICES=1 python train.py --model resnet110 --loss cross_entropy --dataset cifar100 --name c100_resnet110_ce &
